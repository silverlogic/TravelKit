...
extension UIStoryboard {
    ...
    static func loadInitialViewController() -> UINavigationController {
        ...
        guard let controller = storyboard.instantiateInitialViewController() as? UINavigationController else {
            fatalError("UINavigationController does not exist in Bank.storyboard!")
        }
        return controller
    }

    static func loadAccountBalanceNavigationController() -> AccountBalanceNavigationController {
        let storyboard = UIStoryboard(name: "AccountBalance", bundle: nil)
        guard let controller = storyboard.instantiateInitialViewController() as? AccountBalanceNavigationController else {
            fatalError("UINavigationController does not exist in Bank.storyboard!")
        }
        return controller
    }

    static func loadAuthenicateNavigationController() -> AuthenicateNavigationController {
        let storyboard = UIStoryboard(name: "Authenicate", bundle: nil)
        guard let controller = storyboard.instantiateInitialViewController() as? AuthenicateNavigationController else {
            fatalError("UINavigationController does not exist in Bank.storyboard!")
        }
        return controller
    }
